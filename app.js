...
const SPORT_ICONS = {
    ...
    "Core Power": `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2Q4 4 4 12t4 10M16 2q4 2 4 10t-4 10"/><rect x="7" y="4" width="4" height="4" rx="1" fill="currentColor"/><rect x="13" y="4" width="4" height="4" rx="1" fill="currentColor"/><rect x="7" y="10" width="4" height="4" rx="1" fill="currentColor"/><rect x="13" y="10" width="4" height="4" rx="1" fill="currentColor"/><rect x="8" y="16" width="3.5" height="3" rx="1" fill="currentColor"/><rect x="12.5" y="16" width="3.5" height="3" rx="1" fill="currentColor"/></svg>`,
    ...
    "Kickbox-Power": `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M6 5c0-1.5 1-2.5 2.5-2.5h7c2.5 0 4.5 2 4.5 5v4c0 3-2 5-6 5h-4c-2.5 0-4-1.5-4-4V5z" fill="currentColor"/><path d="M6 9h12"/><rect x="8" y="14.5" width="4" height="7" rx="1" fill="currentColor"/></svg>`,
