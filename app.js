...
const SPORT_ICONS = {
    ...
    "Qi Gong": `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="4" r="2.5"/><path d="M12 6.5v5"/><ellipse cx="12" cy="12" rx="5" ry="3.5"/><path d="M12 11.5L10 21"/><path d="M12 11.5L14 21"/></svg>`,
