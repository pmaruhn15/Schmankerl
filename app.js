...
const SPORT_ICONS = {
    ...
    "Pilates": `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="5" cy="14" r="2"/><path d="M7 14h8"/><path d="M15 14L19 6"/><path d="M15 14L21 8"/><path d="M8 14L6 17"/><path d="M10 14L8 17"/><path d="M2 18h20"/></svg>`,
    ...
    "Qi Gong": `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="4" r="2.5"/><path d="M12 6.5v5"/><path d="M12 8L9 11"/><path d="M12 8L15 11"/><circle cx="12" cy="13" r="2"/><path d="M12 11.5L10 21"/><path d="M12 11.5L14 21"/></svg>`,
