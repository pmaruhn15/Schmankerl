...
const SPORT_ICONS = {
    ...
    "Fitness Power": `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><line x1="7" y1="12" x2="17" y2="12"/><rect x="4" y="6" width="3" height="12" fill="currentColor" stroke="none"/><rect x="17" y="6" width="3" height="12" fill="currentColor" stroke="none"/><rect x="2" y="8" width="2" height="8" fill="currentColor" stroke="none"/><rect x="20" y="8" width="2" height="8" fill="currentColor" stroke="none"/><path d="M13 7l-2 5h3l-2 5"/></svg>`,
