...
const SPORT_ICONS = {
    ...
    "Core Power": `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="7" y="3" width="4" height="5" rx="1" fill="currentColor"/><rect x="13" y="3" width="4" height="5" rx="1" fill="currentColor"/><rect x="7" y="10" width="4" height="5" rx="1" fill="currentColor"/><rect x="13" y="10" width="4" height="5" rx="1" fill="currentColor"/><rect x="7" y="17" width="4" height="4" rx="1" fill="currentColor"/><rect x="13" y="17" width="4" height="4" rx="1" fill="currentColor"/></svg>`,
