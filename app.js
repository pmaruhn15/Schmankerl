...
const SPORT_ICONS = {
    ...
    "Fitness Classic": `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><line x1="6" y1="12" x2="18" y2="12"/><rect x="2" y="7" width="4" height="10" rx="0" fill="currentColor" stroke="none"/><rect x="18" y="7" width="4" height="10" rx="0" fill="currentColor" stroke="none"/><rect x="6" y="10" width="2" height="4" rx="0"/><rect x="16" y="10" width="2" height="4" rx="0"/></svg>`,
    "Fitness Power": `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><line x1="6" y1="12" x2="18" y2="12"/><rect x="2" y="7" width="4" height="10" rx="0" fill="currentColor" stroke="none"/><rect x="18" y="7" width="4" height="10" rx="0" fill="currentColor" stroke="none"/><rect x="6" y="10" width="2" height="4" rx="0"/><rect x="16" y="10" width="2" height="4" rx="0"/><circle cx="12" cy="12" r="2.5"/></svg>`,
